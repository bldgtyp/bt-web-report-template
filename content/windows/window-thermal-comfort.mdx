...
For Zone 5(B)’s winter comfort-design weather conditions [ 4.8°F (-15.1°C) ], Passive House certification guidelines for this climate would recommend that as long as windows with an Installed R-Value higher than 5.7 hr-ft2-F/Btu [ U-Value less than 0.18 Btu/hr-ft2-F ] are used this will lead to surface temperatures which PHI finds acceptable for thermal comfort. Note, for smaller windows with a lower ‘view-factor’ (less visible to the occupants) slightly lower R-Values may still achieve the desired thermal comfort targets.
